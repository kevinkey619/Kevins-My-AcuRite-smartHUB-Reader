...
namespace AcuLink_Bridge_Reader_CSharp
{
    public partial class frmSetup : Form
    {
        ...
        private void initializeSettings()
        {
            ...
            txtOwApiKey.Text = Properties.Settings.Default.owApiKey;
            txtOwStationId.Text = Properties.Settings.Default.owStationId;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _with1.owStationId = txtOwStationId.Text;
                _with1.owApiKey = txtOwApiKey.Text;
